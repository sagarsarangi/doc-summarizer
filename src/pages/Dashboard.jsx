  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 lg:h-screen gap-6 p-6 overflow-auto">
        ...
        <div className="bg-gray-900/70 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 shadow-2xl flex flex-col overflow-hidden max-h-full">
    ...
    ${isClearDisabled ? "opacity-60" : "hover:shadow-lg"}`}
        ...
        <div className="bg-gray-900/60 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-7 shadow-2xl flex flex-col overflow-hidden max-h-full">
