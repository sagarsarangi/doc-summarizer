    ...
    >
        ...
        >
          ...
          <div className="flex items-center justify-center min-h-[calc(100vh)] z-10">
            ...
            <div className="fixed right-10 w-70 h-300 hidden [@media(min-width:1090px)]:block [@media(min-width:1360px)]:hidden">
              <Spline
                scene="https://prod.spline.design/CjDsD8tqkdCOdO8W/scene.splinecode"
            ...
            <div className="fixed right-10 w-130 h-300 hidden [@media(min-width:1360px)]:block">
              <Spline
                scene="https://prod.spline.design/CjDsD8tqkdCOdO8W/scene.splinecode"
